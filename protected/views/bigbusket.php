...
<table>
    ...
    <td><?php echo $item['title']; ?></td>
        ...
        <td><input type="text" value=" <?php echo $item['number'] ?>"  id="<?php echo $item['id'] ?>" size="5" data-price="<?php echo $item['price']; ?>"></td>
        </tr>
    <?php endforeach; ?>

</table>

<input type="hidden" name="_token" id="update_busket_token" value="<?php Lib_TokenService::_token('update_busket') ?>" >
